		...
		?><tr>
			<td><?php echo $review->name; ?><?php if (true === $showEdit && user_has('editReviewcycle')) {?>
					<ul class="list-inline table-action">
						...
						<li><a href="<?php echo $currentUrl; ?>view/<?php echo $id; ?>" class="label label-default">View</a></li>
					</ul>
			<?php } ?></td>
			<td><?php echo strip_tags($review->description); ?></td>
...
?>
<?php if (user_has('addReviewcycle')) { ?><a href="<?php echo $currentUrl; ?>add" class="btn btn-primary">New Hourly Cycle</a><?php } ?>
